      ...
      <div className="relative flex flex-col items-center justify-center w-full h-[720px] lg:h-screen gap-y-6">
        ...
        <div className="flex gap-6">
          <a className="" href="https://www.facebook.com/cli.f.ford.104957">
            <svg
              className="size-[30px] fill-[#fff] hover:fill-[#f7d15c]"
              viewBox="0 0 320 512"
            >
              <path d="M279.14 288l14.22-92.66h-88.91v-60.13c0-25.35 12.42-50.06 52.24-50.06h40.42V6.26S260.43 0 225.36 0c-73.22 0-121.08 44.38-121.08 124.72v70.62H22.89V288h81.39v224h100.17V288z"></path>
            </svg>
          </a>
          <a className="" href="https://www.instagram.com/clifford111601/">
            <svg
              className="size-[30px] fill-[#fff] hover:fill-[#f7d15c]"
              viewBox="0 0 448 512"
            >
          ...
          <a
            className=""
            href="https://www.linkedin.com/authwall?trkInfo=AQGi4IfDu8xybAAAAZdE4iXog5xdEJZcs2MCkNP7vkshYmNoUehHBdPLNL1jnPhZca7u5zUv_IE2V1mbjExrdSzFZfuIOIIVyt73UYSdLKycXmKMTW2VvDH6Z84DgkgPYIFj-Kk=&original_referer=&sessionRedirect=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fiyac-clifford-jay-999071346%3Futm_source%3Dshare%26utm_campaign%3Dshare_via%26utm_content%3Dprofile%26utm_medium%3Dandroid_app"
          >
            <svg
              className="size-[30px] fill-[#fff] hover:fill-[#f7d15c]"
              viewBox="0 0 448 512"
          ...
          <a className="" href="https://github.com/Ford-byte">
            <svg
              className="size-[30px] fill-[#fff] hover:fill-[#f7d15c]"
              viewBox="0 0 496 512"
            >
        ...
        <div className="absolute bottom-4 left-0 flex flex-col items-center justify-center w-full gap-2">
          ...
          <div className="mouse-border border w-[25px] h-[40px] rounded-full flex items-center justify-center">
            <div className="wheel w-[5px] h-[5px] bg-white rounded-full scroll-wheel-animation"></div>
          </div>
        </div>
      </div>
      <About />
